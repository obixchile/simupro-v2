    ...
    <div className="p-6 max-w-2xl font-['Roboto',sans-serif]">
      ...
      <div className="space-y-4 bg-white p-6 rounded-lg border border-gray-100">
        ...
        <div>
          ...
          <input type="email" defaultValue="admin@energycore.cl" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" disabled />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" defaultValue="EnergyCore" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" disabled />
        </div>
